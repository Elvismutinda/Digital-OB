...
<body>
    ...
    <ul class="nav-links">
      <li>
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="policepage.php">Dashboard</a></li>
        </ul>
      </li>
      <li>
        <a href="addcomplaint.php">
          <i class='bx bx-user-plus' ></i>
          <span class="link_name">Add Complaint</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="addcomplaint.php">Add complaint</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
  ...
  <div class="home-section">
    <div class="home-content">
      ...
      <div class="username">
        <h4> <?php echo $rows['name']." (". $_SESSION['police_id']." , ". $rows['rank'].")"; ?></h4>
      </div>
      <div class="user">
