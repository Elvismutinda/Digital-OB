...
if(isset($_POST['submit'])){
    ...
    if ($prepareStmt) {
      ...
      $log_message = "$date_time,\t$agent_name,\t$agent_id,\t$agent_rank,\t$agent_station,\tAdded $name suspected of $crime_suspected to their Suspect list\n";
            ...
            <div class="form-content">
               <div class="form-box">
                  ...
                  <select name="ob_number" required onchange="fetchCrimeType()">
                     ...
                     <?php
                     $case_query = "SELECT * FROM cases WHERE station='$station' && investigator='$investigator'";
